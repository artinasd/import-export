    ...
    <section id="why-us" className="bg-[#171816] py-24 text-white lg:py-32">
      <div className="container-site">
        <div className="grid gap-14 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div><p className="mb-5 inline-flex rounded-lg border border-[#c9a66b]/20 bg-[#c9a66b]/[0.10] px-4 py-2 text-base font-bold text-[#c9a66b]">چرا شرکت</p><h2 className="font-display text-balance text-4xl font-black leading-[1.15] tracking-tight sm:text-5xl lg:text-7xl">در تجارت فقط<br /><span className="text-[#c9a66b]">قیمت مهم نیست.</span></h2></div>
