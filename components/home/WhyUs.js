    ...
    <section id="why-us" className="bg-[#171816] py-24 text-white lg:py-32">
      <div className="container-site">
        <div className="grid gap-14 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div><p className="mb-6 inline-flex rounded-xl border border-[#c9a66b]/25 bg-[#c9a66b]/[0.08] px-3.5 py-2 text-base font-bold text-[#c9a66b]">چرا شرکت</p><h2 className="font-display text-balance text-4xl font-black leading-[1.2] sm:text-5xl">در تجارت فقط<br /><span className="text-[#c9a66b]">قیمت مهم نیست.</span></h2></div>
