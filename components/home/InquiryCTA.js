      ...
      <div className="container-site relative">
        <div className="grid gap-14 lg:grid-cols-[1fr_.7fr] lg:items-center lg:gap-24">
          <div>
            ...
            <h2 className="font-display text-balance text-4xl font-black leading-[1.18] sm:text-5xl lg:text-7xl">
              کالای مورد نیازتان را<br /><span className="text-[#c9a66b]">پیدا نمی‌کنید؟</span>
            </h2>
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3">
              {benefits.map((item) => <span key={item} className="flex items-center gap-2 text-xs text-white/55"><Check size={14} className="text-[#c9a66b]" />{item}</span>)}
            </div>
          </div>
          ...
          <a href="#contact" className="group relative flex min-h-60 flex-col justify-between overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.025] p-7 transition duration-500 hover:-translate-y-1 hover:border-[#c9a66b]/60 sm:p-9">
            ...
            <span className="relative flex h-11 w-11 items-center justify-center rounded-full bg-white text-black"><Search size={18} /></span>
            <span className="relative flex items-center justify-between gap-4 text-lg font-bold">ثبت استعلام تأمین<span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#c9a66b] text-black transition group-hover:-translate-x-1"><ArrowLeft size={16} /></span></span>
          </a>
        </div>
      </div>
    </section>
