    ...
    <section id="services" className="bg-[#f3f2ed] py-24 lg:py-32">
      <div className="container-site">
        <div className="mb-14 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div><p className="mb-4 inline-flex rounded-lg border border-[#98783f]/15 bg-[#98783f]/[0.08] px-4 py-2 text-base font-bold text-[#98783f]">خدمات کلیدی</p><h2 className="font-display max-w-3xl text-balance text-4xl font-black leading-[1.18] tracking-tight sm:text-5xl lg:text-7xl">تأمین کالا، <span className="text-[#98783f]">فراتر از خرید.</span></h2></div>
