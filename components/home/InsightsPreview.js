  ...
  return (
    <section id="insights" className="bg-[#f4f3ef] py-24 lg:py-32">
      <div className="container-site">
        <div className="mb-14 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between"><div><p className="mb-4 inline-flex items-center gap-2 rounded-lg border border-[#98783f]/15 bg-[#98783f]/[0.08] px-4 py-2 text-base font-bold text-[#98783f]"><BookOpen size={15} /> دانش تجارت</p><h2 className="font-display max-w-2xl text-balance text-4xl font-black leading-[1.18] tracking-tight sm:text-5xl lg:text-6xl">دانش تجارت، برای تصمیم بهتر.</h2><p className="mt-5 max-w-xl text-sm leading-8 text-[#686963]">اطلاعات تخصصی درباره واردات، صادرات، گمرک، HS Code، تأمین و حمل‌ونقل.</p></div><a href="#" className="flex w-fit items-center gap-2 text-sm font-bold transition hover:text-[#98783f]">ورود به دانش تجارت <ArrowUpLeft size={15} /></a></div>
