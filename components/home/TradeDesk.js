...
const tools = [
  [FileSearch, "فرم RQF", "درخواست خود را ثبت کنید تا اطلاعات لازم برای تأمین دقیق جمع‌آوری شود."],
  [Scale, "جستجوی کد تعرفه گمرکی", "برای بررسی اولیه کالا، کد تعرفه و اطلاعات مرتبط را سریع‌تر پیدا کنید."],
  [Link2, "مقررات و منابع رسمی", "دسترسی به لینک‌های کاربردی تجارت، گمرک و منابع دولتی در یک نقطه."]
];
