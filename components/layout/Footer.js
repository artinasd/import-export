...
const quickLinks = [["خانه", "#top"], ["خدمات", "#services"], ["تأمین کالا", "#services"], ["دانش تجارت", "#insights"], ["درباره ما", "#about"], ["تماس با ما", "#contact"]];
const serviceLinks = [["تأمین کالا", "#services"], ["اعتبارسنجی تأمین‌کننده", "#services"], ["بازرسی کالا", "#services"], ["لجستیک و ترخیص", "#services"]];
    ...
    <footer id="contact" className="bg-[#171816] text-white">
      <div className="container-site py-20 lg:py-24">
        <div className="mb-16 grid gap-12 lg:grid-cols-[1.2fr_.8fr]">
          <div><p className="mb-5 text-sm font-bold text-[#c9a66b]">درخواست همکاری</p><h2 className="font-display max-w-2xl text-balance text-4xl font-black leading-[1.2] sm:text-6xl">نیاز شما → بررسی → تأمین → کنترل → تحویل</h2><p className="mt-6 max-w-xl text-sm leading-8 text-white/45">شرکت تولیدی و بازرگانی؛ تأمین کالا و مدیریت تجارت بین‌المللی.</p><a href="#inquiry" className="mt-8 inline-flex items-center gap-3 rounded-full bg-[#c9a66b] px-6 py-4 text-sm font-bold text-[#171816] transition hover:bg-white">درخواست تأمین کالا <ArrowUpLeft size={15} /></a></div>
